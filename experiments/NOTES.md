...
- **Params are NOT transfer-stable across app builds.** entropy=0.0025 went from stable (build ~349) to reliably-collapsing (build 390). Re-validate any "known-good" config after an app change touching the training/probe path; the collapse-detector commit alone shifted dynamics (see archive/walkback-build390-summary.md).
