...
final class CliTrainingRecorderTests: XCTestCase {
    ...
    private func makeStats(steps: Int, positions: Int) -> CliTrainingRecorder.StatsLine {
        CliTrainingRecorder.StatsLine(
            ...
            emittedGames: 5,
            emittedPositions: positions,
            selfPlayDrawKeepFraction: 1.0,
            selfPlayMaxPliesPerGame: 400,
            maxPliesDropped: 0,
            avgLen: 42.5,
            rollingAvgLen: 40.0,
            gameLenP50: 40,
            ...
            ratioProducedRate: 300,
            ratioConsumptionRate: 310,
            selfPlayMovesPerHour: 3600 * 300,
            trainingMovesPerHour: 3600 * 310,
